local Statistics = {
    ...
    Text = {
        Left = { X = -40, Y = 13, Scale = 0.35 },
    },
    Bar = { Right = 8, Y = 22, Width = 200, Height = 10, OffsetRatio = 0.5 },
    Divider = {
        [1] = { X = 200, Y = 22, Width = 2, Height = 10 },
        [2] = { X = 200, Y = 22, Width = 2, Height = 10 },
        [3] = { X = 200, Y = 22, Width = 2, Height = 10 },
        [4] = { X = 200, Y = 22, Width = 2, Height = 10 },
        [5] = { X = 200, Y = 22, Width = 2, Height = 10 },
    }
}
...
function RageUI.StatisticPanel(Percent, Text, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Statistics.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + (RageUI.StatisticPanelCount * 42), Statistics.Background.Width + CurrentMenu.WidthOffset, Statistics.Background.Height, 19, 19, 19, 170)
            RenderText(Text or "", CurrentMenu.X + 8.0, (RageUI.StatisticPanelCount * 40) + CurrentMenu.Y + Statistics.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 4, Statistics.Text.Left.Scale, 245, 245, 245, 255, 0)
