...
function RageUI.ColourPanel(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)
    ...
    if CurrentMenu ~= nil then
        if Index == nil then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Colour.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Colour.LeftArrow.Width + CurrentMenu.WidthOffset + 400, Colour.Background.Height,  19, 19, 19, 170)
        ...
        elseif CurrentMenu() and CurrentMenu.Index == Index then
            ---@type number
            local Maximum = (#Colours > 9) and 9 or #Colours
