...
--[[
  ...
  File [Skin.lua] created at [29/10/2022 11:28]
...
RedFW.Client.Components.Player.skin = {
    default = {}
}

function RedFW.Client.Components.Player.skin:load(skinTable)
    local playerPed = PlayerPedId()
    RedFW.Client.Components.Player.skin.default = skinTable
...
function RedFW.Client.Components.Player.skin:getSavedSkin()
    local skin = nil
    RedFW.Client.Components.Callback:triggerServer("RedFW:Player:getSkin", function(skinTable)
        skin = skinTable
    end)
    while skin == nil do
        Citizen.Wait(0)
